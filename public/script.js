document.addEventListener("DOMContentLoaded", () => {
  ...
  // Event Listener for searchButton, Input
  ...
  // Lazy Load images after iniital load
  ...
  function createCard(podcast) {
    ...
    img.src = podcast.image || "./default-podacst.png";
  ...
  function createEpisodeCard(episode) {
    ...
    const img = document.createElement("img");
    img.src = episode.image || episode.feedImage || "./default-podacst.png";
  ...
  function loadPodcast(episode) {
    ...
    player.load();
    image.src = episode.image || episode.feedImage || "./default-podacst.png";
  ...
  // Check is screen width is < 1025px
  ...
  // Load saved player state form local storage
